...
# Funny Gunny Phrase Generator VER4_rf
...
def generate_funny_phrase():
    ...
    part_c = random.choice([
            ...
            "hitting the snooze button on a smoke alarm",
            "tuning a piano with a blowtorch",
            "while getting a root canal from Stevie Wonder",
            "calibrating the stupidity meter",
...
if __name__ == "__main__":
            main()
# Funny Gunny Phrase Generator VER4rf
